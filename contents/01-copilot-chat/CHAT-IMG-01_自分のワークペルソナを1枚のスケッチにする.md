...
| **入力** | **自分の業務データ**：Work IQ の業務コンテキスト ＋ LinkedIn 公開プロフィール ＋ 顔写真（任意） |
| **成果** | 自分の仕事内容、ステークホルダー、役割、価値観、大切にしていることを表したホワイトボード風スケッチ s5|
...
- [自社のホームページから企業紹介インフォグラフィックを作る｜CHAT_IMG-02](./CHAT-IMG-02_自社のホームページから企業紹介インフォグラフィックを作る.md)
