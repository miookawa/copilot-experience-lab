...
| **所要** | 約 10 分（目安） |
| **利用** | Microsoft Copilot Chat（スクリーンショット入力） |
| **入力** | **自分の業務データ**：Copilot Studio、Azure ポータル、GitHub、Power Platform 管理センターなど、見慣れない画面 |
| **成果** | その画面の役割・設定項目の意味・次に何をすればよいかの初心者向け解説 s4 |
