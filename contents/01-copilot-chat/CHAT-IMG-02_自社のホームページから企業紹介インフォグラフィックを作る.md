...
| **所要** | 約 10 分（目安） |
| **利用** | Microsoft Copilot Chat |
| **入力** | **公開情報**：自社ホームページの URL |
| **成果** | 会社概要、事業内容、強み、提供価値、企業姿勢をまとめた企業紹介インフォグラフィック s5|
...
この演習では、Microsoft Copilot Chat に**自社ホームページの URL**を渡し、公開されている情報をもとに企業紹介インフォグラフィックを作成させます。
...
1. Microsoft Copilot Chat で新しいチャットを開始する
...
- [自分のワークペルソナスケッチを作成｜CHAT_IMG-01](./CHAT-IMG-01_自分のワークペルソナを1枚のスケッチにする.md)
