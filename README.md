...
[`contents/assets/lakeshore-sample-data-ja/`](./contents/assets/lakeshore-sample-data-ja) に個別ファイル、[`lakeshore-sample-data-ja.zip`](./contents/assets/lakeshore-sample-data-ja.zip) に一式があります。
