...
進行役の説明例：「これは似顔絵を作る演習ではありません。Copilot が業務コンテキストから、あなたの仕事をどう理解しているかを可視化する演習です。」
...
```text
このスケッチを「3年後に目指す自分」の姿へアップデートしたいです。
未来の自分を表すホワイトボード風スケッチを作成してください。
...
**利用できない場合の進め方**
事前に用意した生成例画像を見せ、「この画像からどのような仕事や価値観が読み取れるか」「本人ならどこを修正するか」を参加者に問いかけます。
